...
import { faUser, faIdCard, faEnvelope, faLock, faEye, faEyeSlash, faCircleExclamation } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="bg-white rounded-3xl shadow-lg p-6 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <FontAwesomeIcon icon={faUser} className="w-4 h-4 md:w-5 md:h-5" />
              </span>
              <input
                id="username"
                name="username"
            ...
            {errors.username ? (
              ...
              <p className="text-xs text-gray-500 mt-1">Username akan disimpan dalam huruf kecil</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <FontAwesomeIcon icon={faIdCard} className="w-4 h-4 md:w-5 md:h-5" />
              </span>
              <input
                id="fullName"
                name="fullName"
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <FontAwesomeIcon icon={faWhatsapp} className="w-4 h-4 md:w-5 md:h-5" />
              </span>
              <input
                id="phone"
                name="phone"
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <FontAwesomeIcon icon={faLock} className="w-4 h-4 md:w-5 md:h-5" />
              </span>
              <input
                id="password"
                name="password"
              ...
              >
                <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} className="w-4 h-4 md:w-5 md:h-5" />
              </button>
            </div>
            {errors.password && (
          ...
          {registerError && (
            <div className="flex items-start gap-2 p-2.5 bg-red-50 border border-red-200 rounded-xl animate-shake">
              <FontAwesomeIcon icon={faCircleExclamation} className="w-4 h-4 text-red-500 flex-shrink-0 mt-0.5" />
