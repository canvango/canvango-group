...
import { faUser, faLock, faEye, faEyeSlash, faCircleExclamation } from '@fortawesome/free-solid-svg-icons';
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            ...
            {errors.identifier ? (
              ...
              <p className="text-xs text-gray-500 mt-1">Username tidak membedakan huruf besar/kecil</p>
            )}
          </div>
