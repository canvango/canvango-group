...
const ClaimWarranty: React.FC = () => {
  ...
  // Fetch data
  const { data: claimsData, isLoading: claimsLoading, error: claimsError } = useWarrantyClaims();
    ...
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-red-900 mb-1">Gagal Memuat Data</h3>
            <p className="text-sm text-red-700">
              Terjadi kesalahan saat memuat data klaim garansi. Silakan refresh halaman atau coba lagi nanti.
            </p>
          </div>
        </div>
      </div>
