                  ...
                  <tr key={claim.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">
                        {claim.purchase?.products?.category}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    <p className="text-sm"><span className="font-medium">Name:</span> {selectedClaim.user?.full_name}</p>
                    <p className="text-sm"><span className="font-medium">Email:</span> {selectedClaim.user?.email}</p>
                    <p className="text-sm"><span className="font-medium">Username:</span> {selectedClaim.user?.username}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    <p className="text-sm"><span className="font-medium">Product:</span> {selectedClaim.purchase?.products?.product_name}</p>
                    <p className="text-sm"><span className="font-medium">Type:</span> {selectedClaim.purchase?.products?.product_type}</p>
                    <p className="text-sm"><span className="font-medium">Category:</span> {selectedClaim.purchase?.products?.category}</p>
                    <p className="text-sm"><span className="font-medium">Warranty Expires:</span> {formatDate(selectedClaim.purchase?.warranty_expires_at || '')}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    <p className="text-sm"><span className="font-medium">Claim Type:</span> <span className="capitalize">{selectedClaim.claim_type}</span></p>
                    <p className="text-sm"><span className="font-medium">Status:</span> <StatusBadge status={selectedClaim.status === 'reviewing' ? 'processing' : selectedClaim.status as any} /></p>
                    <p className="text-sm"><span className="font-medium">Created:</span> {formatDate(selectedClaim.created_at)}</p>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-sm text-gray-700">{selectedClaim.reason}</p>
                  </div>
                </div>
