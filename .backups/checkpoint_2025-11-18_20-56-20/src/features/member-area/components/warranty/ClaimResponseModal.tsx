      ...
      <div className="p-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-900 mt-1">#{claim.transactionId.slice(0, 12)}</p>
            </div>
            <div>
              <label className="text-xs font-medium text-gray-500 uppercase tracking-wider">
                Account ID
              </label>
              <p className="text-sm text-gray-900 mt-1">#{claim.accountId.slice(0, 12)}</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-900 mt-1">{getReasonLabel(claim.reason)}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-900 mt-1 whitespace-pre-wrap">{claim.description}</p>
          </div>
        </div>
        ...
        {claim.adminResponse && (
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-gray-900 whitespace-pre-wrap">{claim.adminResponse}</p>
          </div>
        )}

        {/* No Response Yet */}
        {!claim.adminResponse && claim.status === ClaimStatus.PENDING && (
