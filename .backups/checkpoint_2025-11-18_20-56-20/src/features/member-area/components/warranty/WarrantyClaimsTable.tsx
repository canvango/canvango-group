...
const WarrantyClaimsTable: React.FC<WarrantyClaimsTableProps> = ({ 
  ...
  // Calculate warranty expiration from account
  const getWarrantyExpiration = (): string => {
    // In a real app, this would come from the account data
                ...
                <td className="px-6 py-4">
                  <div className="text-sm">
                    <div className="font-medium text-gray-900">
                      #{claim.accountId.slice(0, 8)}
                    </div>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="text-sm text-gray-900">{getReasonLabel(claim.reason)}</span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
