      ...
      if (token) {
        try {
          ...
          const userData = await Promise.race([
            ...
            console.warn('⚠️ Failed to fetch fresh user data:', err.message);
            return null;
          }) as User | null;
          ...
          if (userData) {
            ...
            console.log('⚠️ No user data available, clearing tokens');
          ...
          if (cachedUserData) {
            ...
            console.log('✅ Using cached user data after initialization error');
          } else {
