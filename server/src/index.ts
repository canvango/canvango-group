...
import adminWarrantyRoutes from './routes/admin.warranty.routes.js';
...
import productAccountRoutes from './routes/productAccount.routes.js';
...
// Note: mongoSanitize disabled because we use PostgreSQL (Supabase), not MongoDB
...
app.use(`${apiPrefix}/user`, userRoutes); // Alias for backward compatibility
...
app.use(`${apiPrefix}/admin/warranty-claims`, adminWarrantyRoutes);
...
app.use(`${apiPrefix}/product-accounts`, productAccountRoutes);
